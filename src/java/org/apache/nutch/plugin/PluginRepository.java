...
public class PluginRepository {
  ...
  private Map<String, PluginDescriptor> filter(Pattern excludes,
    ...
    LOG.info("not included : " + StringUtils.join(notIncludedPlugins, ", "));
    LOG.info("excluded : " + StringUtils.join(excludedPlugins, ", "));
    LOG.info("loaded : " + StringUtils.join(loadedPlugins.keySet(), ", "));
