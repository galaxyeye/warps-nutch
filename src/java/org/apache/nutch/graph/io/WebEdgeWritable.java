 ...
 */
public class WebEdgeWritable implements Writable {
  private Configuration conf;
  private WebEdge edge;

  public WebEdgeWritable(WebEdge edge, Configuration conf) {
    this.conf = conf;
    this.edge = edge;
  }

  public WebEdge get() { return edge; }
