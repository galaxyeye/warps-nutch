...
public class CleaningJob extends NutchJob implements Tool {
  ...
  public static class CleanMapper extends GoraMapper<String, WebPage, String, WebPage> {
  ...
  public static class CleanReducer extends Reducer<String, WebPage, NullWritable, NullWritable> {
    ...
    public void cleanup(Context context) throws IOException {
      ...
      LOG.info("deleted a total of " + numDeletes + " documents");
    }
  }

  @Override
  public void setup(Map<String, Object> args) {
    boolean commit = NutchUtil.getBoolean(args, ARG_COMMIT, true);
    getConf().setBoolean(ARG_COMMIT, commit);
  }
  ...
  public static void main(String[] args) throws Exception {
    int result = ToolRunner.run(NutchConfiguration.create(), new CleaningJob(), args);
    System.exit(result);
  }
