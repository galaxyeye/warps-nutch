...
public class WebGraphUpdateJob extends NutchJob implements Tool {
  ...
  public WebGraphUpdateJob() {
  }

  public WebGraphUpdateJob(Configuration conf) {
    setConf(conf);
  }
...
//    currentJob.setCombinerClass(WebGraphUpdateReducer.class);
//    currentJob.setCombinerKeyGroupingComparatorClass(UrlOnlyComparator.class);
    ...
    StorageUtils.initMapperJob(currentJob, fields, GraphGroupKey.class, WebGraphWritable.class, WebGraphUpdateMapper.class, batchIdFilter);
    StorageUtils.initReducerJob(currentJob, WebGraphUpdateReducer.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    int res = ToolRunner.run(ConfigUtils.create(), new WebGraphUpdateJob(), args);
    System.exit(res);
  }
}
